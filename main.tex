...
\usepackage[a4paper, top=0.5in,bottom=0.2in, left=0.75in, right=0.75in, footskip=0.3in, includefoot]{geometry}
...
\tcolorboxenvironment{claim}{boxrule=0pt,boxsep=0pt,blanker,borderline west={2pt}{0pt}{Green},left=8pt,right=8pt,before skip=10pt,after skip=10pt,breakable}
...
\titleformat{\subsection}{\fontsize{12}{14}\sffamily\bfseries}{\thesubsection}{12pt}{#1}
...
\title{\huge\sffamily\bfseries MATH 602 Functional Analysis}
